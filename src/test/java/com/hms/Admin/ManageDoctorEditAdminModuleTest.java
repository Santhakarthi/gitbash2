...
public class ManageDoctorEditAdminModuleTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("(//a[@class='btn btn-transparent btn-xs'])[161]")).click();
        driver.findElement(By.xpath("//select[@name='Doctorspecialization']")).click();
        driver.findElement(By.xpath("//option[@value='medicine']")).click();
        driver.findElement(By.xpath("//button[@name='submit']")).click();
